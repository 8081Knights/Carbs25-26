...
public class HeadlessTest extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        DcMotor FLdrive = hardwareMap.dcMotor.get("FLdrive");
        DcMotor BLdrive = hardwareMap.dcMotor.get("BLdrive");
        DcMotor FRdrive = hardwareMap.dcMotor.get("FRdrive");
        DcMotor BRdrive = hardwareMap.dcMotor.get("BRdrive");
